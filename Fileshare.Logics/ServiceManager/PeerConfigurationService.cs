...
namespace Fileshare.Logics.ServiceManager
{
    public class PeerConfigurationService : IPeerConfigurationService<PingService>
    {
        ...
        private PeerEndPointsCollection _endPoints;
        #endregion
        ...
        public PeerEndPointsCollection PeerEndPoints
        {
            get => _endPoints;
...
#pragma warning restore 618
        ...
        bool IPeerConfigurationService<PingService>.StartPeerService()
        {
            throw new NotImplementedException();
        }

        bool IPeerConfigurationService<PingService>.StopPeerService()
        {
            throw new NotImplementedException();
        }
    }
